        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
                ...
                <div class="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={vivekImg} alt="Helene Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Vivek Sahu</a>
                        </h3>
                        <p>Full-Stack Developer</p>
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={roneetImg} alt="Jese Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={diveshImg} alt="Joseph Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Divesh Kankan</a>
                        </h3>
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={bhaveshImg} alt="Sofia Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={hasanImg} alt="Leslie Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Hasan Khan</a>
                        </h3>
                        <p>Back-End Developer</p>
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={moniImg} alt="Michael Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                    ...
                    <div class="text-center text-gray-500 dark:text-gray-400">
                        <Image class="mx-auto mb-4 w-36 h-36 rounded-full" src={omkarImg} alt="Neil Avatar" />
                        <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                            <a href="#">Omkar Anbhule</a>
                        </h3>
                        <p>Backend Developer</p>
                        <ul class="flex justify-center mt-4 space-x-4">
                            <li>
